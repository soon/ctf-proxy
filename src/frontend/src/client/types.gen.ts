...
export type ClientOptions = {
	baseUrl: "http://localhost:48957" | (string & {});
};
...
export type AnalyzerTagTimeStatsApiAnalyzerTagTimeStatsGetData = {
	body?: never;
	path?: never;
	query: {
		/**
	...
	url: "/api/analyzer/tag-time-stats";
};

export type AnalyzerTagTimeStatsApiAnalyzerTagTimeStatsGetErrors = {
	/**
	 * Validation Error
	 */
	422: HttpValidationError;
...
export type AnalyzerTagTimeStatsApiAnalyzerTagTimeStatsGetError =
	AnalyzerTagTimeStatsApiAnalyzerTagTimeStatsGetErrors[keyof AnalyzerTagTimeStatsApiAnalyzerTagTimeStatsGetErrors];

export type AnalyzerTagTimeStatsApiAnalyzerTagTimeStatsGetResponses = {
	/**
	 * Successful Response
	 */
...
export type AnalyzerTagTimeStatsApiAnalyzerTagTimeStatsGetResponse =
	AnalyzerTagTimeStatsApiAnalyzerTagTimeStatsGetResponses[keyof AnalyzerTagTimeStatsApiAnalyzerTagTimeStatsGetResponses];
